-- 롯데리아 땡스버거: OFFLINE(34.avif), RESULT(35.avif) 이미지를 별도 섹션으로
-- 분리해 각각 한 줄씩(전체 폭) 배치합니다.
...
update works set gallery = '[
  ...
  },
  {
    ...
    "images": [{"url":"https://llwbqewucexzruxdgveq.supabase.co/storage/v1/object/public/work-images/work-campaign/LOTTERIA%20-%20THANKS%20BURGER/34.avif","width":1470,"height":827}]
  },
  {
    "heading": "CAMPAIGN RESULTS",
    "images": [{"url":"https://llwbqewucexzruxdgveq.supabase.co/storage/v1/object/public/work-images/work-campaign/LOTTERIA%20-%20THANKS%20BURGER/35.avif","width":1470,"height":827}]
  }
