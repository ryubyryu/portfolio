...
const fallbackWorks: Work[] = [
  ...
  // Campaign 실제 경력. 사용자가 지정한 순서대로 정리했습니다.
  {
    ...
    description: [
      ...
      "온라인에서의 참여가 실제 오프라인으로 이어져\n세월의 흔적으로 낡고 벗겨진 벽면에 아티스트의 그래픽을 페인팅하여, 시장을 전시장으로 만들다.",
    ],
    stats: [
  ...
  },
  {
    ...
    description: [
      "온라인 강좌 플랫폼 클래스101을 활용하여 다채로운 색감으로 사랑받는 작가 '누아'와 함께 LG그램 360 클래스로 제품의 특장점을 전달하다.",
    ],
    gallery: [
      {
  ...
  },
  {
    ...
    description: [
      "롯데리아에서 한 해 가장 사랑받은 버거를 재출시하며 캠페인 영상부터 나만의 캐릭터로 카드를 만드는 사이트까지\n롯데리아를 매개체로 연말연시 고마운 사람들에게 땡스~한 마음을 서로 전할 수 있는 IMC 캠페인을 설계.",
    ],
    links: [
  ...
  },
  {
    ...
    summary:
      "과감한 개성의 나이키 에어맥스Dn 스타일 컨텐츠. 케이팝 아티스트들의 스타일링을 책임지고 있는 스타일리스트 김영진과 모델 채종석의 룩을 통해\n에어맥스 Dn만의 독보적인 스타일을 표현하다.",
    description: [
  ...
  },
  {
    ...
    summary:
      "gramGO AI 상상여행사, AI를 활용한 BTL 캠페인. 신제품 LG 그램 프로의 고성능을 체험시키기 위해 음악, 이미지, 대화형 3종의 생성형 AI를 해치와 함께\n여행을 떠나듯 경험해보는 여행사 컨셉의 체험형 캠페인 진행",
    description: [
      "gramGO AI 상상여행사, AI를 활용한 BTL 캠페인.\n신제품 LG 그램 프로의 고성능을 체험시키기 위해 음악, 이미지, 대화형 3종의 생성형 AI를 해치와 함께\n여행을 떠나듯 경험해보는 여행사 컨셉의 체험형 캠페인 진행",
    ],
    gallery: [
      {
        columns: 3,
  ...
  },
  {
    ...
    description: [
      "LG 그램 AI를 활용하는 나만의 VI법을 소개하는 그램VI법 컨텐츠 제작.\n대학생과 직장인들을 타겟으로 총 8편 에피소드로 구성해, LG 그램 Pro의 핵심 AI 기능들을 다양한 방법으로 소개한다.",
    ],
    gallery: [
      {
        heading: "BACKGROUND",
  ...
  },
  {
    ...
    description: [
      ...
      "그 답을 증명하기 위한 아워홈 급식 연구소의 '급이 다른 미식' 캠페인 런칭.\n급식 최초 블루리본 도전 과정을 담은 비하인드 영상부터 급식 셰프 5인의 메뉴 개발 과정 소개, 캠페인 사이트 운영과 리뷰 이벤트 진행.",
    ],
    gallery: [
      {
  ...
  },
  {
    ...
    description: [
      ...
      "캠페인 콘셉트를 기반으로 비비고 글로벌 SNS 채널 @bibigo.global의 인스타그램 및 X 콘텐츠를 기획·제작\n브랜드 필름과 마이크로사이트 bibigo HOUSE의 비주얼 에셋을 활용해 캠페인 메시지를 소셜 콘텐츠 전반에 일관되게 적용하며\n글로벌 팬들과의 접점을 확장했다.",
    ],
    links: [
  ...
  },
  {
    ...
    description: [
      ...
      "레시피 소개를 비롯해 비하인드 영상, 밸런스 게임 등 다양한 부가 콘텐츠를 통해 브랜드 경험을 소셜 콘텐츠로\n확장하며 팬들과의 접점을 넓혔다.",
    ],
    gallery: [
      {
        columns: 3,
