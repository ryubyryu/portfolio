...
const fallbackWorks: Work[] = [
  ...
  // 아래는 2022.06.03 이후 Copywriter로 전환한 뒤의 Content 실제 경력입니다.
  {
    slug: "kleenex-clean-together",
    title: "크리넥스 클린투게더",
    category: "Content",
    year: 2022,
    role: "Copywriter",
    client: "크리넥스",
    summary: "화장지와 청소용품을 함께 쓰는 습관을 제안한 캠페인.",
    description: ["데코앤소프트 6s", "데코앤소프트 FULL"],
  },
  {
    slug: "kleenex-ultraclean",
    title: "크리넥스 울트라클린",
    category: "Content",
    year: 2022,
    role: "Copywriter",
    client: "크리넥스",
    summary: "물때·곰팡이 제거력을 소구한 화장실 청소용품 캠페인.",
    description: ["울트라클린 15s", "울트라클린 6s"],
  },
  {
    slug: "kakao-pr-campaign",
    title: "카카오 기업 PR 캠페인",
    category: "Content",
    year: 2023,
    role: "Copywriter",
    client: "카카오",
    summary: "보이지 않는 곳에서의 노력을 담은 기업 PR 캠페인.",
    description: ["1cm² 속 보이지 않는 카카오의 노력"],
  },
  {
    slug: "nike-rhr",
    title: "나이키 RHR",
    ...
    role: "Copywriter",
    client: "Nike",
    summary: "러너들이 서로를 돕는다는 메시지를 담은 러닝 캠페인.",
    description: ["RHR"],
  },
  {
    slug: "nike-well-collective",
    title: "나이키 Well Collective",
    category: "Content",
    year: 2023,
    role: "Copywriter",
    client: "Nike",
    summary: "건강한 라이프스타일을 제안하는 웰니스 콘텐츠 시리즈.",
    description: [
      "Well collective_Better Together",
      "Well collective_Movement",
      "Well collective_Morning Ritual",
    ],
  },
  {
    slug: "nike-style-story",
    title: "나이키 Style Story",
    category: "Content",
    year: 2023,
    role: "Copywriter",
    client: "Nike",
    summary: "스타일 아이콘들의 이야기를 담은 콘텐츠 시리즈.",
    description: [
      "Style Story - 세븐틴 호시",
      "Style Story - 세븐틴 호시편 15초",
      "STYLE STORY -V2K 허니제이",
    ],
  },
  {
    slug: "nike-3style",
    ...
    role: "Copywriter",
    client: "Nike",
    summary: "한 켤레의 신발을 세 가지 스타일로 소화하는 콘텐츠.",
    description: ["3Style - 세븐틴 호시", "코르테즈3Style-허니제이"],
  },
  {
    slug: "nike-airmax-dn",
    title: "나이키 Airmax DN",
    ...
    role: "Copywriter",
    client: "Nike",
    summary: "에어맥스 DN 신제품을 소개하는 캠페인.",
    description: ["Airmax DN- 모델 채종석", "Airmax DN-스타일리스트 김영진"],
  },
  {
    slug: "nike-fitting-room",
    title: "나이키 Fitting Room",
    category: "Content",
    year: 2024,
    role: "Copywriter",
    client: "Nike",
    summary: "선수의 피팅룸 비하인드를 담은 콘텐츠.",
    description: ["Fitting Room_안세영 선수"],
  },
  {
    ...
    role: "Copywriter",
    client: "롯데리아",
    summary: "고마운 마음을 전하자는 메시지를 담은 버거 캠페인.",
    description: ["고마운 사람에게 마음을 전하세요"],
  },
  {
    ...
    role: "Copywriter",
    client: "LG",
    summary: "그램 활용법을 소개하는 시리즈 콘텐츠.",
    description: [
      "그램VI법_Teaser",
      "그램VI법01_애러 난 과제 파일 구출법",
      "그램VI법02_시험 준비 교수님 소환술",
      "그램VI법03_과제 지옥 탈출법",
      "그램VI법04_일잘러의 회의 준비법",
      "그램VI법05_휴가 복귀 후 밀린 메일 정리법",
      "그램VI법06_경력같은 신입사원 되는 법",
      "그램VI법07_누구보다 빠르게 남들과는 다른 편집법",
      "그램VI법08_쿨하게 무릎 책상 쓰기",
      "잇츠 오케이의 그램VI법 01_애로우? 루나? CPU 뭐가 다르지?",
      "잇츠 오케이의 그램VI법 02_프로들을 위한 멀티태스킹",
      "잇츠 오케이의 그램VI법 03_4K 편집 가능한 그램 Pro 외장그래픽",
    ],
  },
  {
    slug: "lg-gram-go-ai-2024",
    title: "LG 그램 GO AI 상상여행사",
    category: "Content",
    year: 2024,
    role: "Copywriter",
    client: "LG",
    summary: "AI 기능을 담은 그램 신제품 캠페인.",
    description: ["LG gram GO AI 상상여행사 2024"],
  },
  {
    ...
    role: "Copywriter",
    client: "G-SHOCK",
    summary: "이승협과 함께한 G-SHOCK 스타일 캠페인.",
    description: ["ICONIC STYLES : LEE SEUNG HYUB"],
  },
];
